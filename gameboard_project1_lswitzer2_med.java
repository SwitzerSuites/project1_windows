...
public class gameboard_project1_lswitzer2_med extends javax.swing.JFrame {
     ...
     */
    public gameboard_project1_lswitzer2_med() {
        initComponents();
        setColor();
    }
    ...
    private void setColor(){
        Random r = new Random();
        mainColor = new Color(r.nextInt(256), r.nextInt(256), r.nextInt(256));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gameboard_project1_lswitzer2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gameboard_project1_lswitzer2().setVisible(true);
            }
        });
    }
